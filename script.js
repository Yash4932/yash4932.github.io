...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const blockedDomains = [
      'test.com','fake.com','dummy.com','example.com','mailinator.com',
      'guerrillamail.com','tempmail.com','yopmail.com','trashmail.com',
      'aaa.com','abc.com','xyz.com','asdf.com','qwerty.com',
      'test.in','fake.in','dummy.in'
    ];
    const blockedLocal = [
      'test','fake','dummy','asdf','qwerty','abc','xyz',
      'aaa','bbb','ccc','123','temp','noreply','no-reply'
    ];
